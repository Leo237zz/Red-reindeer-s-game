...
class Animation:
    def __init__(self, filename, frame_size=(128, 128), num_frames=11, initial_position=(100, 280)):
    ...
    def draw(self, screen):
        scaled_frame = pygame.transform.scale(self.frames[self.frame_index], (self.frame_width*1.25, self.frame_height*1.25))
